...
<head>
    ...
    <title>Admin Login — Pixies Bridal Saloon</title>
...
<body class="min-h-screen grid lg:grid-cols-2">
    <div class="hidden lg:block bg-cover bg-center relative" style="background-image:url('{{ asset('images/afr-woman.jpg') }}')">
        <div class="absolute inset-0 bg-charcoal-950/60"></div>
        <div class="absolute bottom-12 left-12 text-white">
            <p class="font-display text-4xl font-semibold">Pixies <span class="text-gold-400">Bridal</span></p>
    ...
    <div class="flex items-center justify-center p-8">
        <div class="w-full max-w-md">
            <div class="text-center mb-8">
                ...
                <p class="text-charcoal-400 mt-2">Sign in to manage your salon.</p>
            </div>
            ...
            <form action="{{ route('login.attempt') }}" method="POST" class="space-y-5">
                ...
                <div>
                    ...
                    <input name="email" type="email" value="{{ old('email') }}" required autofocus class="field" placeholder="admin@pixiesbridal.co.tz">
                </div>
                <div>
