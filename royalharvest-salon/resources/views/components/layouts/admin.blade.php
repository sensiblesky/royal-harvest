...
@php
    $nav = [
        ...
        ['label' => 'Bookings', 'route' => 'admin.bookings', 'match' => 'admin.bookings'],
        ['label' => 'Enquiries', 'route' => 'admin.enquiries', 'match' => 'admin.enquiries'],
        ['label' => 'Services', 'route' => 'admin.services', 'match' => 'admin.services'],
        ['label' => 'Messages', 'route' => 'admin.contacts', 'match' => 'admin.contacts'],
        ['label' => 'Subscribers', 'route' => 'admin.subscribers', 'match' => 'admin.subscribers'],
...
<head>
    ...
    <title>{{ $title }} — Pixies Admin</title>
    ...
    <aside class="bg-charcoal-900 text-white/80 flex flex-col lg:min-h-screen">
        <div class="p-6 border-b border-white/10">
            <a href="{{ route('admin.index') }}" class="font-display text-2xl font-semibold text-white">
                Pixies <span class="text-gold-400">Admin</span>
            </a>
        </div>
