...
<aside class="main-sidebar elevation-4 sidebar-light-primary">
    ...
    <a href="{{route("admin.index")}}" class="brand-link">
      <img src="{{asset('static/img/logo.png')}}" alt="." class="brand-image image-cirlce"
           style="opacity: .8">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{route('admin.index')}}" class="nav-link">
                  <i class="far fa-circle nav-icon {{ Request::routeIs('admin.index') ? 'text-danger' : '' }}"></i>
                  <p>Dashboard</p>
                </a>
              </li>
            </ul>
          ...
          <li class="nav-item has-treeview {{ Request::routeIs('admin.users.index') ? 'menu-open' : '' }}">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{Request::routeIs('admin.users.index') ?  '' : route("admin.users.index")}}" class="nav-link">
                  <i class="far fa-circle nav-icon {{ Request::routeIs('admin.users.index') ? 'text-danger' : '' }} "></i>
                  <p>All Users</p>
                </a>
              </li>
          ...
          <li class="nav-item has-treeview {{ Request::routeIs('admin.updates.index') ? 'menu-open' : '' }}">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{Request::routeIs('admin.updates.index') ?  '' : route("admin.updates.index")}}" class="nav-link">
                  <i class="far fa-circle nav-icon {{ Request::routeIs('admin.updates.index') ? 'text-danger' : '' }} "></i>
                  <p>All</p>
                </a>
              </li>
