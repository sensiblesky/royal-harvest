<x-layouts.base title="Home">
    ...
    <section class="home-slider owl-carousel">
        <div class="slider-item" style="background-image:url({{ asset('static/images/bg_6.jpg') }});">
        ...
        <div class="slider-item" style="background-image:url({{ asset('static/images/bg_7.jpg') }});">
            <div class="overlay"></div>
            <div class="container">
                <div class="row no-gutters slider-text align-items-center justify-content-start"
                    data-scrollax-parent="true">
         ...
         <div class="slider-item" style="background-image:url({{ asset('static/images/bg_8s.jpg') }});">
            <div class="overlay"></div>
            <div class="container">
                <div class="row no-gutters slider-text align-items-center justify-content-start"
                    data-scrollax-parent="true">
         ...
         <div class="slider-item" style="background-image:url({{ asset('static/images/bg_1.jpg') }});">
            <div class="overlay"></div>
            <div class="container">
                <div class="row no-gutters slider-text align-items-center justify-content-start"
                    data-scrollax-parent="true">
            ...
            <div class="row no-gutters">
                <div class="col-md-3 d-flex services align-self-stretch py-5 px-4 ftco-animate bg-primary">
                    <div class="media block-6 d-block text-center">
                        ...
                        <div class="media-body p-2 mt-3">
                            <h3 class="heading">Bridal Makeup & Styling</h3>
                            <p>Customized bridal hairstyle & Trial makeup session</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-3 d-flex services align-self-stretch py-5 px-4 ftco-animate bg-darken">
                    <div class="media block-6 d-block text-center">
                        ...
                        <div class="media-body p-2 mt-3">
                            <h3 class="heading">Hair Care & Styling</h3>
                            <p>Bridal buns & floral styling & Hair spa & treatment packages</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-3 d-flex services align-self-stretch py-5 px-4 ftco-animate bg-primary">
                    <div class="media block-6 d-block text-center">
                        ...
                        <div class="media-body p-2 mt-3">
                            <h3 class="heading">Bridal Accessories & Add-Ons</h3>
                            <p>Hair extensions & accessories & Customized bridal packages</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-3 d-flex services align-self-stretch py-5 px-4 ftco-animate bg-darken">
                    <div class="media block-6 d-block text-center">
                        ...
                        <div class="media-body p-2 mt-3">
                            <h3 class="heading">Professional Makeup Services</h3>
                            <p>Studio photoshoot makeup& Natural, glam, and editorial finishes</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row d-flex">
                ...
                <div class="col-md-7 wrap-about py-5 pr-md-4 ftco-animate">
                    <h2 class="mb-4"><Strong>Pixies Bridal Saloon</Strong> <br> What We Offer</h2>
                    <p>At Pixies Bridal Saloon, we turn your special moments into unforgettable memories.
                        Our team blends creativity, artistry, and premium products to bring out the most confident,
                        radiant version of you.
                        Whether it's your wedding day, engagement, or a glamorous event — we ensure you look and feel
                        extraordinary
                    ...
                    <div class="row mt-5">
                        <div class="col-lg-6">
                            <div class="services-2 d-flex">
                                ...
                                <div class="text pl-3">
                                    <h3>Bridal Makeup & Styling</h3>
                                    <p>Full bridal glam and Traditional & modern bridal looks</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="services-2 d-flex">
                                ...
                                <div class="text pl-3">
                                    <h3>Engagement & Pre-Wedding Glam</h3>
                                    <p>Engagement makeup & hair,Pre-wedding shoot looks and Soft glam or bold beauty</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="services-2 d-flex">
                                ...
                                <div class="text pl-3">
                                    <h3>Professional Makeup Services</h3>
                                    <p>Party & evening makeup & Matron of honor / bridesmaid styling</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="services-2 d-flex">
                                ...
                                <div class="text pl-3">
                                    ...
                                    <p>Haircut & blow-dry, Creative updos and curls ,Bridal buns & floral styling </p>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="services-2 d-flex">
                                ...
                                <div class="text pl-3">
                                    <h3>Beauty & Skin Preparation</h3>
                                    <p>Facials (glow, brightening, bridal), Skin prep packages for brides Eyebrows,
                                        lashes & tinting</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="services-2 d-flex">
                                ...
                                <div class="text pl-3">
                                    <h3>Bridal Accessories & Add-Ons</h3>
                                    <p>Jewelry & veil styling ,Hair extensions & accessories and Customized bridal
                                        packages.</p>
                                </div>
                            </div>
                        </div>
