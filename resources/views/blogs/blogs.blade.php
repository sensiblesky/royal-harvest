          ...
          <div class="col-md-6 col-lg-4 ftco-animate">
            <div class="blog-entry">
              ...
              <div class="text bg-white p-4">
                <h3 class="heading"><a href="">{{ $update->title }}</a></h3>
                <p>{{ $update->content }}</p>
                <div class="d-flex align-items-center mt-4">
	                <p class="mb-0"><a href="{{ route('blogs.show',$update->id ) }}" class="btn btn-primary">Read More <span class="ion-ios-arrow-round-forward"></span></a></p>
